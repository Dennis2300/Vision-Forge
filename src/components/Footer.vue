    ...
    <div class="p-8">
      ...
      <div class="space-y-4 text-white/80 text-sm leading-relaxed">
        <p class="hover:text-white/90 transition-colors duration-300">
          ...
          <strong class="text-white">miHoYo</strong>. All characters, images,
          names, and other assets used on this site are the property of
          <strong class="text-white">HoYoverse</strong>.
        </p>
        <p class="hover:text-white/90 transition-colors duration-300">
          Built with
          <strong
            ><a
              ...
              class="text-white hover:text-pink-200 transition-colors duration-300 underline decoration-pink-300/50"
              >Vue.js</a
            ></strong
          >
          and
