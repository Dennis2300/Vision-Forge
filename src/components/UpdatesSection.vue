  ...
  <section class="max-w-[800px] mx-auto p-4 min-h-72 mb-10">
    ...
    <div v-if="updates.length" class="flex flex-col gap-8">
      <article
        ...
        :key="update.id"
        class="bg-secondary border border-tertiary rounded-2xl p-6 
               shadow-md transition-all duration-200 hover:-translate-y-1 
               hover:shadow-xl"
      >
        <header class="mb-4">
          ...
          <div class="flex gap-3 text-sm text-gray-400">
            <span
              class="bg-[#292929] px-2 py-[2px] rounded-md font-mono text-gray-300"
            >
              #{{ update.slug }}
            </span>
